(function () {
  ...
  const RU = {
    ...
    "Divanmi, mashinami, usta kerakmi — bitta qidiruvda.":"Диван, машина или мастер — всё в одном поиске.",
    ...
    "Barcha manba bitta joyda":"Все источники в одном месте",
    ...
    "Arzonidan, yangisidan yoki yaqinidan saralab ko‘ring. Ochiq e’lonlarning hammasi ko‘rinadi.":"Сортируйте по цене, новизне или близости. Видны все открытые объявления.",
    "Bir tegish — so‘rov mos sotuvchilarga boradi. Telefon raqami so‘ralmaydi.":"Одно нажатие — запрос уходит подходящим продавцам. Номер телефона не требуется.",
    ...
    "Telefon raqamingiz va Telegram orqali kelgan kod bilan istalgan qurilmadan kirasiz. Savdo xabarlari OBER ichida qoladi.":"Входите с любого устройства по номеру телефона и коду из Telegram. Переписка по сделке остаётся внутри OBER.",
    ...
    "OBER ichida so‘rash":"Спросить внутри OBER",
    "Telefon raqami ochilmaydi. Taklif va yozishma OBER ichida qoladi.":"Номер телефона не раскрывается. Предложение и переписка остаются внутри OBER.",
    ...
    "Telegram faqat bir martalik kirish kodlari uchun. So‘rov, taklif va yozishmalar OBER ichida qoladi.":"Telegram используется только для одноразовых кодов входа. Запросы, предложения и переписка остаются внутри OBER.",
    "Kirishga bog‘lash":"Привязать для входа",
    "Yangi javob Chat nishonida ko‘rinadi. Savdo OBER ichida qoladi.":"Новый ответ появится на значке чата. Сделка остаётся внутри OBER.",
    ...
    "Siz":"Вы",
    "Aloqa va rasmlar OBER ichida qoladi":"Контакты и фото остаются внутри OBER",
    ...
    "Chatda yozing — javob xaridorga OBER ichida boradi.":"Напишите в чат — ответ уйдёт покупателю внутри OBER.",
